...
<div id="wrapper">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">대표 이미지 변경</h1>
    </div>
    <div class="container my-3">
        <div class="row mb-3">
            <div class="col-6">
                <div class="border p-2 bg-dark text-white fw-bold">대표 이미지</div>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-6">
                    ...
                    <div id="imageContainer">
                        <c:forEach var="img" items="${images}">
                            <div class="form-group col mb-3">
                                ...
                                <input type="radio" class="form-check-input m-2 " name="imgNo" value="${img.no}" />
